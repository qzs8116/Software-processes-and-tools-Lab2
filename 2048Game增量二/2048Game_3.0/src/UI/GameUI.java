...
public class GameUI{
    ...
    public void showButton(int num, int goldCoin, int max_score){
        ...
        score.setBounds(dimensions*100*5/8, 50, 200, 20);
        score.setText("分数：" + String.valueOf(num));
        frame.add(score);

        coin.setBounds(dimensions*100*3/8,50, 80, 20);
        coin.setText("金币：" + String.valueOf(goldCoin));
        frame.add(coin);

        maxScore.setBounds(dimensions*100*5/8-25, 10, 200, 20);
        maxScore.setText("最高得分：" + String.valueOf(max_score));
        frame.add(maxScore);

        up.setBounds(dimensions*100/2-30, 125+dimensions*100, 60, 60);
        down.setBounds(dimensions*100/2-30, 195+dimensions*100, 60, 60);
        left.setBounds(dimensions*100/2-100, 195+dimensions*100, 60, 60);
        right.setBounds(dimensions*100/2+40, 195+dimensions*100, 60, 60);
        ...
        frame.setSize(20+dimensions*100, 300+dimensions*100);
